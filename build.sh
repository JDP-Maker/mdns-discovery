...
GOOS=windows GOARCH=386 GO386=softfloat go build -o distrib/windows32/mdns-discovery.exe
GOOS=windows GOARCH=amd64 go build -o distrib/windows64/mdns-discovery.exe
